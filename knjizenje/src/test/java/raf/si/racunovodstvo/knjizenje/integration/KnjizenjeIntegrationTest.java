...
public class KnjizenjeIntegrationTest {
    ...
    void findAllTest() throws Exception {
        ...
        //List<KnjizenjeResponse> lista = objectMapper.convertValue(map.get("content"), new TypeReference<>() {});
        //assertTrue(lista.stream().anyMatch(KnjizenjeResponse -> KnjizenjeResponse.getBrojNaloga().equals(MOCK_BR_NALOGA)));
        //KnjizenjeResponse jedan = objectMapper.convertValue(map.get("content"), new TypeReference<>() {});
        Knjizenje dva = objectMapper.readValue(mvcResult.getResponse().getContentAsString(), new TypeReference<>() {});
